...
namespace NextCommerce\Core\Block\Adminhtml\Page\Assets;
...
class FontAwesomeInit extends Template
{
    ...
    private const XML_PATH_IS_ACTIVE = 'nextcommerce_core/ui/is_active_fontawesome';
    private const XML_PATH_SOURCE = 'nextcommerce_core/ui/fontawesome_resource';
