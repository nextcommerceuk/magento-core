...
{
    private const XML_PATH_IS_ACTIVE = 'nextcommerce_core/dev/is_active_mail_log';
    private const XML_PATH_RECIPIENT = 'nextcommerce_core/dev/mail_log_email';
    private const XML_PATH_EMAIL_IDENTITY = 'nextcommerce_core/dev/mail_log_email_identity';
    private const XML_PATH_EMAIL_TEMPLATE = 'nextcommerce_core/dev/mail_log_email_template';
